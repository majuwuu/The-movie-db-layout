...
const SvgTMDB = ({ active }: SvgTMDBProps) => {
	return (
		<div className=" flex justify-center items-center bg-gray-600 h-screen w-screen ">
			<svg
				...
				<polygon
					...
					className="svg-elem-6"></polygon>
			</svg>
		</div>
	);
};
export default SvgTMDB;
