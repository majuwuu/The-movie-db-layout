...
function de() {
  return q || (q = 1, process.env.NODE_ENV !== "production" && function() {
    function r(l) {
      ...
      if (typeof l == "object")
        switch (typeof l.tag == "number" && console.error(
          ...
          case te:
            return i = l.displayName || null, i !== null ? i : r(l.type) || "Memo";
          case I:
    ...
    function n(l) {
      ...
      if (i) {
        i = console;
        var x = i.error, u = typeof Symbol == "function" && Symbol.toStringTag && l[Symbol.toStringTag] || l.constructor.name || "Object";
        return x.call(
          i,
    ...
    function N(l, i, x, u, p, f, P, O) {
      ...
      if (Y.call(i, "key")) {
        h = r(l);
        var v = Object.keys(i).filter(function(ce) {
          return ce !== "key";
        });
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    var w = oe, C = Symbol.for("react.transitional.element"), z = Symbol.for("react.portal"), E = Symbol.for("react.fragment"), X = Symbol.for("react.strict_mode"), Q = Symbol.for("react.profiler"), K = Symbol.for("react.consumer"), ee = Symbol.for("react.context"), le = Symbol.for("react.forward_ref"), se = Symbol.for("react.suspense"), re = Symbol.for("react.suspense_list"), te = Symbol.for("react.memo"), I = Symbol.for("react.lazy"), ie = Symbol.for("react.activity"), ne = Symbol.for("react.client.reference"), M = w.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, Y = Object.prototype.hasOwnProperty, ae = Array.isArray, A = console.createTask ? console.createTask : function() {
      return null;
    };
    w = {
    ...
    T.Fragment = E, T.jsx = function(l, i, x, u, p) {
...
var G;
function ue() {
  return G || (G = 1, process.env.NODE_ENV === "production" ? S.exports = xe() : S.exports = de()), S.exports;
}
var e = ue();
const he = () => /* @__PURE__ */ e.jsx(
...
] }), o = ({ label: r, size: t, weigth: n, color: s }) => /* @__PURE__ */ e.jsx("div", { className: "m-0 p-0", children: /* @__PURE__ */ e.jsx(
  "span",
  {
    style: {
      fontSize: t,
          ...
          children: [
            /* @__PURE__ */ e.jsx("a", { className: " whitespace-nowrap", children: /* @__PURE__ */ e.jsx(
              o,
              {
                ...
                color: s.title !== t ? "--color-tertiary-gray" : void 0
              }
            ) }),
...
), ye = ({ rate: r }) => /* @__PURE__ */ e.jsxs("div", { className: "flex items-center w-full h-full ", children: [
    ...
    children: [
      ...
      /* @__PURE__ */ e.jsxs("div", { className: "flex  justify-between px-4.5 items-center  relative z-10", children: [
        ...
        /* @__PURE__ */ e.jsxs("div", { className: "flex ", children: [
          ...
          /* @__PURE__ */ e.jsx("div", { className: "mr-2", children: c ? /* @__PURE__ */ e.jsx(ye, { rate: c }) : /* @__PURE__ */ e.jsx(F, { label: a, color: "#FFFFFF" }) })
        ] })
      ] })
    ]
  }
  ...
  return /* @__PURE__ */ e.jsxs("div", { className: "w-full h-full relative rounded-[20px] overflow-hidden", children: [
    /* @__PURE__ */ e.jsxs("div", { className: "relative", children: [
      (g == null ? void 0 : g.length) && !N && /* @__PURE__ */ e.jsx("div", { className: "absolute top-2 left-0 mx-2", children: /* @__PURE__ */ e.jsx(Re, { currentViewers: g }) }),
    ...
    /* @__PURE__ */ e.jsx("div", { className: "absolute left-0 bottom-0 w-full", children: t && !C && /* @__PURE__ */ e.jsx(
      "div",
      {
        className: `absolute left-0 bottom-0 w-full transition-opacity duration-300 ${C ? "opacity-0 pointer-events-none" : "opacity-100"}`,
        children: /* @__PURE__ */ e.jsx(
          Ce,
          {
            title: t,
  ...
  /* @__PURE__ */ e.jsxs("section", { children: [
    ...
    /* @__PURE__ */ e.jsx("div", { className: "flex flex-col gap-6  w-full sm:grid sm:grid-cols-2 lg:flex lg:flex-row lg:gap-8", children: t.length === 0 ? /* @__PURE__ */ e.jsx(Fe, {}) : t.map((s) => /* @__PURE__ */ e.jsx(
      "article",
      {
  ...
  /* @__PURE__ */ e.jsxs("section", { className: "pt-9.5", children: [
    ...
    /* @__PURE__ */ e.jsx("div", { className: "flex flex-col gap-6 pb-6  w-full sm:grid sm:grid-cols-2 lg:flex lg:flex-row lg:gap-7.5", children: n.length === 0 ? /* @__PURE__ */ e.jsx(_e, {}) : n.map((s) => /* @__PURE__ */ e.jsx(
      "article",
      {
  ...
  let n = null;
  const s = () => {
    const a = t.filter((d) => d !== n), c = a[Math.floor(Math.random() * a.length)];
    return n = c, c;
  };
  return /* @__PURE__ */ e.jsxs("div", { className: " w-full px-6 lg:px-12.5 ", children: [
    ...
    /* @__PURE__ */ e.jsx("div", { className: "flex flex-wrap gap-5 w-58  ", children: r.allCategories.map((a, c) => /* @__PURE__ */ e.jsx("div", { className: "cursor-pointer", children: /* @__PURE__ */ e.jsx(F, { color: s(), label: a }, c) })) })
  ] });
  ...
  "svg",
  {
    ...
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      /* @__PURE__ */ e.jsx("circle", { cx: "6", cy: "6", r: "6", fill: "var(--color-secondary-gray)" }),
